...
def parse_args():
    ...
    parser.add_argument('--delta', type=float, default=0.2, help='Initial integration step size (default: 0.2)')
    parser.add_argument('--omega', type=float, default=1.0, help='Hamiltonian flow coupling omega (default: 1.0)')
    ...
    parser.add_argument('--bh-mass', type=float, default=100, help='Black hole mass (default: 100)')
    parser.add_argument('--boundary-radius', type=float, default=None, help='Simulation boundary radius (default: 10*bh_mass)')
    parser.add_argument('--observer-distance', type=float, default=None, help='Observer distance from BH (default: 20*bh_mass)')
